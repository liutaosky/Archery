...
from .models import Users, Instance, SqlWorkflow, SqlWorkflowContent, QueryLog, DataMaskingColumns, DataMaskingRules, \
    ...
    Tunnel, AuditEntry, TwoFactorAuthConfig, IDC, Server, Project, Cluster, ResourceInstance
...
class ServerAdmin(admin.ModelAdmin):
    ...
    list_filter = ('idc', 'server_status', 'resource_group')
    list_display_links = ('server_id', 'server_name')
    filter_horizontal = ('resource_group',)
...
class ProjectAdmin(admin.ModelAdmin):
    ...
    list_filter = ('project_status', 'project_priority', 'resource_group')
...
class ResourceInstanceAdmin(admin.ModelAdmin):
    list_display = ('resource_instance_id', 'instance', 'server', 'cluster', 'project', 'idc', 'instance_env', 'instance_level')
    search_fields = ('instance__instance_name',)
    list_filter = ('instance_env', 'instance_level', 'idc', 'project', 'cluster', 'server')
    list_display_links = ('resource_instance_id', 'instance')
